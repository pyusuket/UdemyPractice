                ...
                <div class="md:p-6 bg-white border-b border-gray-200">
                    <section class="text-gray-600 body-font">
                        <div class="container md:px-5 mx-auto">
                            ...
                            <div onclick="location.href='{{ route('admin.owners.create')}}'" class="flex justify-end mb-4">
                                <button class=" text-white bg-indigo-500 border-0 py-2 px-8 focus:outline-none hover:bg-indigo-600 rounded text-lg">新規登録する</button>
                            </div>
                            ...
                            <table class="table-auto w-full text-left whitespace-no-wrap">
                              ...
                              <tbody>
                                ...
                                <tr>
                                    ...
                                    <button onclick="location.href='{{ route('admin.owners.edit', ['owner' => $owner->id ])}}'" class=" text-white bg-indigo-400 border-0 md:py-2 px-4 focus:outline-none hover:bg-indigo-500 rounded ">編集</button>
                                    </td>
